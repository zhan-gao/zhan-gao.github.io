...
\begin{center}
    {\Huge \scshape Zhan Gao} \\ \vspace{1pt}
    3620 South Vermont Ave. Kaprielian Hall, 300, Los Angeles, CA 90089 \\ \vspace{1pt}
    \small \raisebox{-0.1\height}\faPhone\ +1-424-316-9216 ~ \href{mailto:x@gmail.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{zhangao@usc.edu}} ~ 
    \href{https://github.com/}{\raisebox{-0.2\height}\faGithub\ \underline{github.com/zhan-gao}}
    \vspace{-8pt}
\end{center}
